...
var formatNumber = function(num, type) {
    ...
    return {
        ...
        displayMonth: function() {
            ...
            now = new Date();
            months = ['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябь', 'Ноябрь', 'Декабрь'];
            month = now.getMonth();
        ...
        changedType: function() {
          ...
          document.querySelector(DOMstrings.inputВtn).classList.toggle('red');
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        // выходим к родительскому элементу от целевого
        var itemID = event.target.parentNode.parentNode.parentNode.parentNode.id;
        if(itemID) {
            // разделяют строку на массив
